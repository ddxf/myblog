      ...
      <div class="tab-panel active" id="tab-set">
        <form method="POST" class="form-x" action="/Admin/articleupdate" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="title" name="title" size="50" placeholder="文章标题" data-validate="required:请填写您的文章标题"  value=" <?php echo ($currentArticle['title']); ?>"/>
            </div>
          </div>
          <div class="form-group">
            <div class="label">
          ...
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="author" name="author" size="50" value="<?php echo ($currentArticle['author']); ?>" />
            </div>
          </div>
          <div class="form-group">
            <div class="label">
          ...
          <div class="form-group">
            ...
            <div class="field">
              <textarea name="desc" class="input" rows="2" cols="50" placeholder="请填写文章描述" data-validate="required:请填写文章描述" ><?php echo ($currentArticle['desc']); ?></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="label">
