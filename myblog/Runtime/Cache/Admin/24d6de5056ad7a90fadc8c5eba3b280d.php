...
<div class="admin">
    <form action="/Admin/articledeletes" method="POST">
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            ...
            <a href="/Admin/Articlelist/isdelete/1">
        ...
        <table class="table table-hover">
            <tr>
             ...
             <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                    ...
                    <td><?php echo ($vo['recover']); ?></td>
                    <td>
                         <?php if(empty($isdelete)): ?><a class="button border-blue button-little" href="/Admin/artrecover/<?php echo ($vo['id']); ?>">评论回复</a> 
                            <a class="button border-yellow button-little" href="/Admin/articledelete/<?php echo ($vo['id']); ?>" >删除</a>
                        <?php else: ?> 
